...
export class Migration1758015144676 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "sales_channels" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying(500), "logoUrl" character varying(500), "organizationId" integer NOT NULL, CONSTRAINT "UQ_4aa8d9a1c00ca11dd9faa850c31" UNIQUE ("name", "organizationId"), CONSTRAINT "PK_2cc4a647500deae01e9f9ef0e47" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_organizations" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "organizationId" integer NOT NULL, "role" "public"."user_organizations_role_enum" NOT NULL DEFAULT 'OPERATOR', CONSTRAINT "UQ_481a3d21c68396d6b180ab9795d" UNIQUE ("userId", "organizationId"), CONSTRAINT "PK_51ed3f60fdf013ee5041d2d4d3d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_invitations" ADD CONSTRAINT "FK_6c4273e18d6b7e7b02aa64b4b2d" FOREIGN KEY ("organizationId") REFERENCES "organizations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_invitations" DROP CONSTRAINT "FK_6c4273e18d6b7e7b02aa64b4b2d"`);
