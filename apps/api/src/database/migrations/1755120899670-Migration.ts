...
export class Migration1755120899670 implements MigrationInterface {
    name = 'Migration1755120899670'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_organizations" ("userId" integer NOT NULL, "organizationId" integer NOT NULL, CONSTRAINT "PK_481a3d21c68396d6b180ab9795d" PRIMARY KEY ("userId", "organizationId"))`);
