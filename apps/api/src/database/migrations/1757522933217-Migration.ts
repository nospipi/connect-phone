...
export class Migration1757522933217 implements MigrationInterface {
    name = 'Migration1757522933217'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "audit_logs" ("id" SERIAL NOT NULL, "table_name" character varying NOT NULL, "row_id" character varying NOT NULL, "operation" character varying NOT NULL, "before" jsonb, "after" jsonb, "actor_id" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_1bb179d048bbc581caa3b013439" PRIMARY KEY ("id"))`);
