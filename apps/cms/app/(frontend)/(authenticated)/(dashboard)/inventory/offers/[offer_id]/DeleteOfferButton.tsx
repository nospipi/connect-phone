// apps/cms/app/(frontend)/(authenticated)/(dashboard)/inventory/offers/[offer_id]/DeleteOfferButton.tsx

import { RiDeleteBin6Line } from "@remixicon/react"
import { deleteEsimOfferById } from "@/app/(backend)/server_actions/esim-offers/deleteEsimOfferById"
        ...
        <div className="container mx-auto max-w-5xl px-4 py-6">
          ...
          <div className="mb-6">
            <p className="mb-2 text-gray-700 dark:text-gray-300">
              Are you sure you want to delete the eSIM offer:
            </p>
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            <form action={deleteEsimOfferById}>
              <input type="hidden" name="esimOfferId" value={offer.id} />
