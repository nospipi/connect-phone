// apps/cms/app/(frontend)/(authenticated)/(dashboard)/inventory/offers/[offer_id]/PriceSelectButton.client.tsx
...
interface PriceSelectButtonProps {
  offerId: string
}

export default function PriceSelectButton({ offerId }: PriceSelectButtonProps) {
  ...
  const handleClick = () => {
    ...
    const url = `/inventory/prices/select?${urlParams.toString()}`
