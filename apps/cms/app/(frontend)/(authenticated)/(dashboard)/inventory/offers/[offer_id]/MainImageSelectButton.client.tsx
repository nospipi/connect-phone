// apps/cms/app/(frontend)/(authenticated)/(dashboard)/inventory/offers/[offer_id]/MainImageSelectButton.client.tsx
...
interface MainImageSelectButtonProps {
  offerId: string
}

export default function MainImageSelectButton({
  offerId,
}: MainImageSelectButtonProps) {
