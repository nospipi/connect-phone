// apps/cms/app/(frontend)/(authenticated)/(dashboard)/inventory/offers/[offer_id]/IsActiveCheckbox.client.tsx
"use client"
...
interface IsActiveCheckboxProps {
  isChecked: boolean
  offerId: string
}

export default function IsActiveCheckbox({
  isChecked,
  offerId,
}: IsActiveCheckboxProps) {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    urlParams.set("isActive", newChecked ? "true" : "false")
    ...
    startTransition(() => {
      router.push(`/inventory/offers/${offerId}?${urlParams.toString()}`)
    })
  }
