// apps/cms/app/(frontend)/(authenticated)/(dashboard)/inventory/offers/create-new/IsActiveCheckbox.client.tsx
"use client"
...
export default function IsActiveCheckbox({ isChecked }: IsActiveCheckboxProps) {
