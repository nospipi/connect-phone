...
export default function PricesFilters({ currentFilters }: PricesFiltersProps) {
  ...
  return (
    <div className="my-2 flex flex-col gap-3 px-5 pr-2">
            ...
            <div className="flex min-w-[200px] flex-1 gap-2">
              <div className="flex-1">
                <input
                  ...
                  step="0.01"
                  min="0"
                  className="block w-full border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 placeholder-gray-500 outline-none focus:border-blue-500 dark:border-slate-700/50 dark:bg-slate-900/50 dark:text-slate-200 dark:placeholder-slate-500 dark:focus:border-slate-700/50"
                />
              </div>
              <div className="flex-1">
                <input
