// apps/cms/app/(frontend)/(authenticated)/(dashboard)/organization/details/LogoSection.client.tsx
"use client"
...
export default function LogoSection({
  ...
  const handleRemove = () => {
    ...
    router.push(`/organization/details?${urlParams.toString()}`)
  }
          ...
          <div className="flex items-center gap-4 p-4">
            <div className="relative h-20 w-20 flex-shrink-0 overflow-hidden rounded-lg border border-gray-200 bg-gray-50 shadow-sm dark:border-gray-700 dark:bg-gray-900">
              <Image
                ...
                alt={selectedLogo.description || "Organization logo"}
                fill
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-medium text-gray-900 dark:text-gray-100">
                {selectedLogo.description || "Organization logo"}
              </p>
            ...
            <div className="flex flex-shrink-0 gap-2">
              <MediaSelectButton
                previousPage="/organization/details"
                targetField="logoId"
